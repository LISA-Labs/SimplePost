...
//  ComicViewer
//
//  Created by General Factory on 2016. 10. 18..
//  Copyright © 2016년 General Factory. All rights reserved.
//

import UIKit

let kImageHeight =                              200.0
let kDefaultCellHeight =                        56.0

let kDefaultBoldFont =                          "AvenirNext-Bold"
let kDefaultFont =                              "AvenirNext-Regular"
let kDefaultLightFont =                         "AvenirNext-UltraLight"
let simplePostContentTitle01Font =              UIFont(name: "AppleSDGothicNeo-Medium", size: 15)
